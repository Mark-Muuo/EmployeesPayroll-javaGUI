...
public class Payroll {
	...
	private void initialize() {
		...
		frmGeorgetownCleaningServices.setForeground(new Color(0, 0, 255));
		frmGeorgetownCleaningServices.setTitle("Georgetown Cleaning Services - Employee Payroll");
		frmGeorgetownCleaningServices.getContentPane().setBackground(new Color(250, 235, 215));
		...
		btnProcess.setBackground(new Color(250, 235, 215));
		btnProcess.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent event) {
				...
				textField_15.setText(String.format("%.2f", regularPay));
				textField_16.setText(String.format("%.2f", overtimeHours));
				textField_17.setText(String.format("%.2f", overtimePay));
				textField_18.setText(String.format("%.2f", netPay));
			}
		});
